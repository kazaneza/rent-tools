...
<head>
    ...
    <title>AddTool:Generator Accessories</title>
...
<div id="main_container"><?php include("lib/menuNavClerk.php"); ?>
    <div class="center_content">
        <div class="title_name">Add Generator Accessories</div>
        ...
        <div id="addAccessories" style="display:none">
            ...
            <form id="accessories" action="add_generator_accessories.php" method="post">
