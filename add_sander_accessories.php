...
<head>
    ...
    <title>AddTool:Sander Accessories</title>
...
<div id="main_container"><?php include("lib/menuNavClerk.php"); ?>
    <div class="center_content">
        <div class="title_name">Add Sander Accessories</div>
        ...
        <div id="addAccessories" style="display:none">
            ...
            <form id="accessories" action="add_sander_accessories.php" method="post">
