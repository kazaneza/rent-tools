...
<head>
    ...
    <title>AddTool:Mixer Accessories</title>
...
<div id="main_container"><?php include("lib/menuNavClerk.php"); ?>
    <div class="center_content">
        <div class="title_name">Add Mixer Accessories</div>
        ...
        <div id="addAccessories" style="display:none">
            ...
            <form id="accessories" action="add_mixer_accessories.php" method="post">
...
<script>
    ...
    nAccessories.addEventListener("input", function(e){
        ...
        <?php if ($_SESSION['power'] == 'gas'): ?>
        var htmlSelect = "<select name='accessType[]' required><option value='Gas Tank'>Gas Tank</option>" +
            ...
            "</select>";
        <?php else: ?>
        var htmlSelect = "<select name='accessType[]' required><option value='Safety Hat'>Safety Hat</option>" +
            "<option value='Safety Pants'>Safety Pants</option>" +
            "<option value='Safety Goggles'>Safety Goggles</option><option value='Safety Vest'>Safety Vest</option>" +
            "</select>";
        <?php endif; ?>
