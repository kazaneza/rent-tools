<?php
    ...
    $query = "SELECT U.first_name, U.middle_name, U.last_name, U.email, " .
        "C.street, C.city, C.state, C.zip_code, C.home_phone, C.work_phone," .
    ...
    if ( !is_bool($result) && (mysqli_num_rows($result) > 0) ) {
        ...
        array_push($error_msg,  "Query ERROR: Failed to get User profile..." . __FILE__ ." line:". __LINE__ );
    }
...
<body>
    <div id="main_container"><?php include("lib/menuNavCustomer.php"); ?>
        ...
        <div class = "center content" style="divScroll">
            <table>
                <tr>
                    <td style="width:8px;vertical-align:top" class="heading">Res. ID</td>
                    <td style="width:25px;vertical-align:top" class="heading">Tool Description</td>
                    <td style="width:12px;vertical-align:top" class="heading">Start Date</td>
                    <td style="width:12px;vertical-align:top" class="heading">End Date</td>
                    <td style="width:20px;vertical-align:top" class="heading">Pick-up Clerk</td>
                    <td style="width:20px;vertical-align:top" class="heading">Drop-off Clerk</td>
                    <td style="width:8px;vertical-align:top" class="heading">Days</td>
                    <td style="width:10px;vertical-align:top" class="heading">Total Deposit Price</td>
                    <td style="width:10px;vertical-align:top" class="heading">Total Rental Price</td>
                </tr>
                    ...
                    <?php
                        $query = "SELECT R.reservation_id, DATE(R.start_date) StartDate, DATE(R.end_date) EndDate, CONCAT(UP.first_name, ' ', UP.middle_name,' '," .
                            ...
                            "WHERE C.customer_id={$_SESSION['id']} GROUP BY R.reservation_id, T.power_source, T.sub_option, T.sub_type_name, " .
                        ...
                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                            print "<tr><td>" . $row['reservation_id'] . "</td><td>" . $row['Description'] . "</td><td>" . $row['StartDate'] . "</td><td>" .
                                ...
                                "</td><td>" . number_format($row['TotDepositPrice'],2) . "</td><td>" .
                                number_format($row['TotRentPrice'],2) . "</td></tr>";
                        }
                    ?>
