...
<head>
    ...
    <title>AddTool:Saw Accessories</title>
...
<div id="main_container"><?php include("lib/menuNavClerk.php"); ?>
    <div class="center_content">
        <div class="title_name">Add Saw Accessories</div>
        ...
        <div id="addAccessories" style="display:none">
            ...
            <form id="accessories" action="add_saw_accessories.php" method="post">
...
<script>
    ...
    nAccessories.addEventListener("input", function(e){
        ...
        var htmlSelect = "<select name='accessType[]' required><option value='Drill Bits'>Saw Blade</option>" +
