...
(CASE WHEN T.power_source='manual'
                   ...
                   ROUND(0.4*T.original_price,1) AS 'Deposit Price', ROUND(0.15*T.original_price,1) AS 'Rental Price'
...
<title>Tools-4-Rent Pick Up Tool Detail</title>
</head>
<body>
...
<h1 style="margin-left:10px">Tool Details</h1>
<hr>

<?php
echo "<p style=\"margin-left:10px\">Tool ID:\n", $tool_id, "<br/>\n";
echo "<p style=\"margin-left:10px\">Tool Type: \n", $row1['category_name'], "<br/>\n";
echo "<p style=\"margin-left:10px\">Short Description: \n", $row1['Short Description'], "<br/>\n";
echo "<p style=\"margin-left:10px\">Full Description: \n", $full_description, "<br/>\n";
echo "<p style=\"margin-left:10px\">Deposit Price: $\n", number_format($row1['Deposit Price'], 2), "<br/>\n";
echo "<p style=\"margin-left:10px\">Rental Price: $\n", number_format($row1['Rental Price'], 2), "<br/>\n";
echo "<p style=\"margin-left:10px\">Accessories: \n";
