...
<div id="main_container"><?php include("lib/menuNavClerk.php"); ?>
    <div class="center_content">
        ...
        <div id="addAccessories" style="display:none">
            <p style="margin-left:10px" style="margin-left:10px"><b>Accessory Quantity:              Accessory Description:</b></p>
            <form id="accessories" action="add_aircompressor_accessories.php" method="post">
...
<script>
    ...
    nAccessories.addEventListener("input", function(e){
        ...
        var htmlSelect = "<select name='accessType[]' required><option value='Hose'>Hose</option>" +
