...
For this to work the core /lib source files need to be agreed up in the beginning of the collaboration.
This will simplify development and avoid excessive merge conflicts in GitHub.
Please use the provided phpMyAdmin/pgAdmin username and password below for all queries and place this db
connection in one php file then call that file on each dependent source file using include('lib/common.php' or db.php);
...
define('DB_SCHEMA', "cs6400_fa17_team040");
